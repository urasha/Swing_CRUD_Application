...
public class StandardPersonCreator implements PersonCreator {
    ...
    private static boolean isInteractiveInput = true;
    private static ArrayList<String> personParams = new ArrayList<>();
    ...
    public StandardPersonCreator() {
        ...
        fieldToValidation.put("Введите координаты (%s): ".formatted(Text.makeItalic("x>-868;y>-230")), this::validateCoordinates);
    ...
    private ArrayList<String> inputPersonData() {
        ...
        for (String phrase : fieldToValidation.keySet()) {
            while (true) {
                ...
                System.out.println(Text.makeBold("Недопустимое значение! Попробуйте ещё раз!"));
            }
        }
